...
// filtering all the data from the API
    ...
    if (isLoading) {
        return <div className="w-full h-screen bg-black flex items-center justify-center text-center">{user?.name}</div>;
    }
    return (
        <>
            <Header />
            ...
            <Timeline educations={filteredEducation} expriences={filteredExperience}/>
